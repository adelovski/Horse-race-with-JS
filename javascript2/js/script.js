...
function insertRows() {
    ...
    actionCol.innerHTML = `<a class="link"> <i id="viewButton-${id}" class="far fa-eye"></i> </a>
                            <a class="link"> <i id="editButton-${id}" class="fas fa-marker"></i> </a>                            
                            <a class="link"> <i id="updateButton-${id}" class="fas fa-save" style="display:none"></i>  </a>                   
                            <a class="link"> <i id="deleteButton-${id}" class="fas fa-trash"></i> </a>`;
